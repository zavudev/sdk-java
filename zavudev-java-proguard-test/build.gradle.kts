...
dependencies {
    testImplementation(project(":zavudev-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../zavudev-java-core/src/main/resources/META-INF/proguard/zavudev-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../zavudev-java-core/src/main/resources/META-INF/proguard/zavudev-java-core.pro",
