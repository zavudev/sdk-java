...
private constructor(
     ...
     */
    fun nextStepId(): Optional<String> = nextStepId.getOptional("nextStepId")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.nextStepId] with `nextStepId.orElse(null)`. */
        fun nextStepId(nextStepId: Optional<String>) = nextStepId(nextStepId.getOrNull())
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (nextStepId.asKnown().isPresent) 1 else 0)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val COLLECT = of("collect")

            @JvmField val CONDITION = of("condition")
