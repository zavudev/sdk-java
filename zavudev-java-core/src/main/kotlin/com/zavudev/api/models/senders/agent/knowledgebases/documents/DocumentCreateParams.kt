...
private constructor(
    ...
    fun kbId(): Optional<String> = Optional.ofNullable(kbId)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.kbId] with `kbId.orElse(null)`. */
        fun kbId(kbId: Optional<String>) = kbId(kbId.getOrNull())
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (content.asKnown().isPresent) 1 else 0) + (if (title.asKnown().isPresent) 1 else 0)
