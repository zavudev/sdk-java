...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun parameters(): Optional<ToolParameters> = body.parameters()

    /**
     * @throws ZavudevInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun webhookSecret(): Optional<String> = body.webhookSecret()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun parameters(): Optional<ToolParameters> = parameters.getOptional("parameters")
