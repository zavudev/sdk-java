...
private constructor(
    ...
    fun urlId(): Optional<String> = Optional.ofNullable(urlId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): UrlRetrieveDetailsParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.urlId] with `urlId.orElse(null)`. */
        fun urlId(urlId: Optional<String>) = urlId(urlId.getOrNull())
