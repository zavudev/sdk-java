...
internal class MessageSendParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.channel()).contains(Channel.AUTO)
        ...
        assertThat(body.fallbackEnabled()).contains(true)
        assertThat(body.htmlBody()).contains("htmlBody")
        assertThat(body.idempotencyKey()).contains("msg_01HZY4ZP7VQY2J3BRW7Z6G0QGE")
        assertThat(body.messageType()).contains(MessageType.TEXT)
        ...
        assertThat(body.replyTo()).contains("support@example.com")
        assertThat(body.subject()).contains("Your order confirmation")
        assertThat(body.text()).contains("Your verification code is 123456")
        assertThat(body.voiceLanguage()).contains("es-ES")
    }
