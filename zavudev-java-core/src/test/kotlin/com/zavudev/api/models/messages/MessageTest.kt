...
internal class MessageTest {
    ...
    fun create() {
        ...
        assertThat(message.conversationId()).contains("js723987cyghwqxxaxcf590qd18axd95")
        assertThat(message.cost()).contains(0.0)
        assertThat(message.costProvider()).contains(0.0)
        assertThat(message.costTotal()).contains(0.0)
        assertThat(message.errorCode()).contains("errorCode")
        assertThat(message.errorMessage()).contains("errorMessage")
        assertThat(message.from()).contains("+13125551212")
        ...
        assertThat(message.providerMessageId()).contains("providerMessageId")
        assertThat(message.senderId()).contains("sender_12345")
